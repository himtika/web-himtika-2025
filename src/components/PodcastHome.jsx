    ...
    return (
        <>
            <section className="pt-14 lg:pt-28 pb-28 px-6 sm:px-16 md:px-14 lg:px-28 bg-yellowBG text-black transition-all duration-500 selection:bg-purple selection:text-white">
                <div className="w-full text-center mb-8 lg:mb-12 transition-all duration-500">
                    <h1 className="font-[Caveat] font-bold text-6xl md:text-7xl text-purple mt-4 leading-10">
                        Podcast
                    </h1>
                </div>
