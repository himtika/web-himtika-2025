...
export default function Footer(){
    ...
    return (
        <>
            <footer className="bg-purple pt-9 lg:pt-12 pb-8 lg:pb-11 px-6 sm:px-16 md:px-16 lg:px-28 selection:bg-white selection:text-purple transition-all duration-500">
                <div className="lg:container transition-all duration-500">
                    <div className="lg:flex lg:justify-between transition-all duration-500">
                        <div className="w-full lg:w-5/12 mb-8 text-slate-300 font-medium flex items-start justify-center lg:justify-normal transition-all duration-500">
                            <div className="">
                                <h2 className="font-[Plus Jakarta Sans] tracking-wide font-semibold text-yellowBright text-6xl lg:text-[64px] leading-none mb-6 lg:mb-7">
                                Himtalks
                                </h2>
                        ...
                        <div className="grid sm:grid-cols-3 grid-cols-2 w-full lg:w-7/12 transition-all duration-500">
                            {/* kolom 1 */}
                            <div className="w-full mb-8 font-[Plus Jakarta Sans] text-white flex justify-center sm:justify-start lg:justify-start transition-all duration-500">
                                <div>
                                    ...
                                    <ul className="text-base">
                                        <Link
                                            href="/berita"
                                            className="inline-block text-base mb-4 hover:scale-125 hover:text-darkPurple antialiased transform will-change-transform origin-left transition-all duration-500"
                                            >
                                            <li>Berita</li>
                                        </Link>
                                        <li>
                            ...
                            {/* kolom 2 */}
                            <div className="w-full mb-8 font-[Plus Jakarta Sans] text-white flex justify-center transition-all duration-500">
                                <div>
                            ...
                            {/* kolom 3 */}
                            <div className="w-full mb-8 font-[Plus Jakarta Sans] text-white flex justify-center sm:justify-end lg:justify-end transition-all duration-500">
                                <div>
                                    <h3 className="font-bold text-white text-xl mb-6">
                                    Aplikasi Publik
                                    </h3>
